 ...
 *
*/
require_once (strtr(realpath(dirname(dirname(__FILE__))), '\\', '/') . '/sabconversion.class.php');
/**
 * mysql-specific implementation of sabConversion
 */
class sabConversion_mysql extends sabConversion {
